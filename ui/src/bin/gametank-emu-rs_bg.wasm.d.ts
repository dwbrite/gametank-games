...
export function update_rom_data(a: number, b: number): void;
...
export function closure567_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5aa50f994c349644(a: number, b: number): void;
export function closure1065_externref_shim(a: number, b: number, c: number, d: number): void;
